...
export default function NewCalculation(props) {
    ...
    return (
        <div onClick={() => {props.close_modal(props.set_new_calculation_modal)}} className={props.new_calculation_modal.wrapper.appear ? "newcalculation" : "newcalculation newcalculation_hidden"}>
